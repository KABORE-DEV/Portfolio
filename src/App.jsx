...
function Navbar({ activePage, navigate, mobileOpen, setMobileOpen }) {
  ...
  /* Secret admin : triple-click sur le logo */
  ...
  return (
    <nav className="navbar">
      {/* Logo */}
      <div className="nav-logo" onClick={handleLogoClick} title="Frank KABORE" aria-label="Frank KABORE">
        <span className="nav-logo-badge" aria-hidden="true"><CoffeeIco /></span>
      </div>
      ...
      <div className="nav-right">
        <button onClick={toggleTheme} className="nav-theme-btn" aria-label="Thème">
    ...
    <>
      ...
      <div className={`mobile-menu ${open ? "open" : ""}`}>
        <div className="mobile-menu-header">
          ...
          <button className="mobile-menu-close" onClick={onClose}><CloseIco /></button>
        </div>
        {NAV.map(n => (
          <button
            key={n.id}
